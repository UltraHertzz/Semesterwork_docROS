...
from car_driver_localpkg.OPi.constants import HIGH, LOW, IN, OUT, \
...
def PWM_Duty_Cycle_Percent(chip, pin, Duty_cycle):  # in percentage
    ...
    # command = ["sudo", "chmod", "666", PWM_period_path]
    # subprocess.run(command)
