...
from car_driver_localpkg.OPi.constants import IN, OUT
from car_driver_localpkg.OPi.constants import LOW, HIGH                     # noqa: F401
from car_driver_localpkg.OPi.constants import NONE, RISING, FALLING, BOTH   # noqa: F401
from car_driver_localpkg.OPi.constants import BCM, BOARD, SUNXI, CUSTOM
from car_driver_localpkg.OPi.constants import PUD_UP, PUD_DOWN, PUD_OFF     # noqa: F401
from car_driver_localpkg.OPi.pin_mappings import get_gpio_pin, set_custom_pin_mappings
from car_driver_localpkg.OPi import event, sysfs
...
class PWM:
    ...
    def __init__(self, chip, pin, frequency, duty_cycle_percent, invert_polarity=False):  # (pwm pin, frequency in KHz)
        ...
        try:
            ...
            """
            sysfs.PWM_Frequency(self.chip, self.pin, self.frequency) # Modifid-lsx
            sysfs.PWM_Duty_Cycle_Percent(self.chip, self.pin, self.duty_cycle_percent) # Modified-lsx
            # sysfs.PWM_Enable(chip, pin) # Modified-lsx
            return sysfs.PWM_Enable(chip, pin)# sysfs.PWM_Frequency(chip, pin, frequency) Modified-lsx
